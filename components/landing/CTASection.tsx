...
export function CTASection() {
  return (
    <section className="py-20 relative overflow-hidden bg-gray-950 text-white text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
          <Link href="/register">
            <ScaleOnHover>
              <Button
                size="lg"
                className="h-20 px-16 text-2xl font-bold shadow-2xl shadow-primary/30 bg-primary hover:bg-primary/90 text-primary-foreground rounded-full"
              >
