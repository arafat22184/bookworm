...
function StatItem({
  ...
  return (
    <FadeIn delay={delay} className="space-y-2 group cursor-default">
      <div className="text-3xl md:text-6xl font-serif font-bold text-transparent bg-clip-text bg-linear-to-br from-primary to-secondary group-hover:scale-110 transition-transform duration-300 ease-out">
        {value}
      </div>
