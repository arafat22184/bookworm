...
const FAQS = [
  {
    q: "Is BookWorm really free?",
    a: "Yes! BookWorm is completely free to use. We believe reading tools should be accessible to everyone.",
  },
  {
    q: "Can I import my library from other apps?",
    a: "Currently, we are working on an import feature. Stay tuned for updates!",
  },
  {
    q: "How are recommendations calculated?",
    a: "We analyze the genres of books you've rated highly and suggest similar titles from our extensive database.",
  },
  {
    q: "Is there a mobile app?",
    a: "BookWorm is a fully responsive web application that works great on any mobile device browser.",
  },
];
